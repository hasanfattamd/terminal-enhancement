...
keep updated.
## Thirteen looks, switchable live
...
Six more themes are the same shape with a different treatment, so you can
switch between them rather than edit anything:

| | |
|---|---|
| `plain` | `Desktop ›` — one line, nothing above it; the smallest of the set |
...
of the theme — so thirteen looks times any color you like.
